...
export const HomePage: React.FC = () => {
  ...
  // No featured story anymore — show the latest 3 news items directly.
  ...
  return (
    <div id="home-page-container" className="space-y-16 sm:space-y-20">
      ...
      >
        ...
        {socialLoading && (
          <LoadingState message="Loading social posts…" />
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {GUIDES_DATA.slice(0, 3).map((guide) => (
            ...
            >
              ...
              <p className="text-xs text-[#8090a8] line-clamp-2 flex-1">
                {guide.subtitle}
              </p>
